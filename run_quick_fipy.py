...
Run directly as a script: python test_quick_fipy.py
"""
...
def run_quick_test(output_dir='model_output/salt_wedge_benchmark'):
    """Run a 2-second simulation and print results."""
    ...
    print('\n1. Creating mesh...')
    mesh_file = os.path.join(output_dir, '_19_sw_quick_test.msh')
